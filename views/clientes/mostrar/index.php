        ...
        <div class="mb-3">
            <form action="<?= URL?>clientes/update/<?=$this->id?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="telefono" value="<?= $this->cliente-> telefono?>" disabled>
                </div>

                <div class="mb-3">

                    <label for="" class="form-label">Ciudad</label>
                    <input type="text" class="form-control" name="ciudad" id="" value="<?= $this->cliente-> ciudad?>" disabled>
                </div>
