<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/nombre">Nombre</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/fecha_alta">Fecha</a></li>
                        <li><a class="dropdown-item" href="<?= URL ?>cuentas/ordenar/fecha_ul_mov">Ul. Mov</a></li>
            ...
            <form class="d-flex" method="get" action="<?= URL ?>cuentas/filtrar">
