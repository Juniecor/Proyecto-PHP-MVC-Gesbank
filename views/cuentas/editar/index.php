            ...
            <form action="<?= URL?>cuentas/update/<?=$this->id?>" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select-lg" value="<?= $this->cuenta->id_cliente?>"  name="id_cliente"id="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" value="<?= $this->cuenta->fecha_alta?>" name="fecha_alta">
                    </div>

                    <div class="mb-3">
                        <label for="" class="form-label">Saldo</label>
                        <input type="number" class="form-control" value="<?= $this->cuenta->saldo?>" id="" name="saldo">
                    </div>
